...
All of the code was written in `r fontawesome::fa(name = "r-project", fill = "#2468BB", height = "1em")` (version 4.3.1). This code book was written using Quarto (version 1.7.30).  
